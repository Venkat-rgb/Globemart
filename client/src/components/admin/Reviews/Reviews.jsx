...
//   console.log("Reviews page: ", paginationModel.page);

//   // Keeps track of input which will search reviews based on productId
//   const productIdRef = useRef();

//   console.log("ProductIdRef: ", productIdRef?.current?.value);
...
//   console.log("totalReviewsCount: ", data?.totalReviewsCount);

//   // Making API request to delete review of product based on reviewId
//   const deleteReviewHandler = async (reviewId) => {
//     console.log(`Delete review with Id: ${reviewId}`);
//     console.log("Delete review with product Id: ", trimmedProductId);

//     try {
//       const trimmedProductId = productIdRef?.current?.value?.trim();

//       console.log("ProductId and reviewId ", trimmedProductId, reviewId);
...
//       console.log("trimmedProductId: ", trimmedProductId);
...
//         console.log("reviewSearchHandler result: ", res);
//       }
//     } catch (err) {
//       toast.error(err?.message || err?.data?.message);
//     }
...
//   // Searching reviews of product based on productId
//   const reviewSearchHandler = async (e) => {
//     e.preventDefault();

//     try {
//       await getReviewsHandler();
//     } catch (err) {
//       toast.error(err?.message || err?.data?.message);
//     }
//   };
...
//             {/* Search Button with loading values */}
//             <Button isLoading={isGetReviewsLoading} moreStyles="w-full">
//               {isGetReviewsLoading ? (
//                 <div className="flex items-center justify-center gap-2">
//                   <p className="text-neutral-300 font-inter font-medium">
//                     Searching
