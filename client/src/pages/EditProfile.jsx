...
//   const { data: userInfo, isLoading: isUserDataLoading } = useGetProfileQuery();
...
//   console.log("EditProfile result: ", userInfo);
...
//       console.log("Updated profile result: ", res);
...
//   // Showing Loader when customer profile data is loading
...
//       />
//       <motion.div
//         className="max-w-xl mx-auto shadow-lg rounded-xl p-5"
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         exit={{ opacity: 0, y: -20 }}
//         transition={{ delay: 0.2 }}
//       >
//         <p className="font-public-sans drop-shadow font-semibold text-2xl text-center">
//           Edit Profile
//         </p>
//         <form
//           onSubmit={editProfileSubmitHandler}
...
/* <motion.div whileTap={{ scale: 0.97 }} className="w-full">
            ...
            >
              {isProfileUpdating ? (
                <div className="flex items-center justify-center gap-2">
                  <p className="text-neutral-600/80 font-medium">
                    Updating Profile
                  </p>
