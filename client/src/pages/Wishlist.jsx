...
//   console.log("Wishlist page: ", page);
...
//         console.log("delete total wishlist result: ", res);
...
//   // Appending wishlist products on inital load (or) during page change (Infinite scroll)
//   useEffect(() => {
//     if (data?.wishList) {
//       setWishListProducts((prev) => [...prev, ...data?.wishList]);
//     }
//   }, [data?.wishList]);

//   // Implementing Infinite scroll and incrementing page number when lastElement is in view
//   useEffect(() => {
//     console.log("lastElement intersecting: ", inView);

//     console.log("wishListProducts length: ", wishListProducts.length);

//     console.log("wishListProducts total count: ", data?.totalWishlistCount);

//     // Incrementing page number only when lastElement is in view and current wishlist products length is < totalWishlistProducts count
//     if (inView && wishListProducts.length < data?.totalWishlistCount) {
//       setPage((prev) => prev + 1);
//     }
//   }, [inView]);
...
//   // Handling any errors during fetching wishlist products
//   if (productsError) {
//     console.log("Wishlist error: ", error?.data?.message);
//   }

//   return (
//     <div className="max-w-[82rem] mx-auto pt-24 pb-12 px-4 space-y-10 relative">
//       <MetaData title="Ecommercy | Wishlist" />

//       <div className="flex items-center justify-between max-[500px]:flex-col gap-4">
//         <p className="font-public-sans font-semibold text-2xl text-neutral-600 drop-shadow">
//           Your Wishlist
//         </p>
//         <div className="flex items-center justify-center gap-5">
//           <Link to="/products">
...
//         <div className="flex items-center justify-center mx-auto w-[50%] rounded-xl pt-5">
//           {/* <LazyImage
//             imageProps={{
//               src: WishlistImage,
//               className: `object-cover w-[50%] rounded-xl -mt-10`,
//               alt: "wishlist-img",
//             }}
//             skeletonWidth={640}
//             skeletonHeight={401}
...
//       {/* Showing below message only when products length is more than 1 page length (which is 9 products) */}
//       {data?.totalWishlistCount && (
//         <div className="font-inter flex items-center justify-center">
//           {wishListProducts.length === data?.totalWishlistCount && (
//             <p className=" drop-shadow text-neutral-500">
//               You have reached the end!
//             </p>
//           )}
...
//           {wishListProducts.length > 9 && (
//             <button
//               className="p-1.5 rounded-full bg-indigo-500 text-[#f1f1f1] fixed right-10 bottom-10"
//               onClick={() => window.scrollTo(0, 0)}
//             >
//               <BsArrowUpShort size={30} />
//             </button>
...
//   return (
//     <div className="max-w-[82rem] mx-auto pt-24 pb-12 px-4 space-y-10">
//       <MetaData title="Ecommercy | Wishlist" />
